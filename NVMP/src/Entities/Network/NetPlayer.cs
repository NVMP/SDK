...
namespace NVMP.Entities
{
    internal class NetPlayer : NetUnmanaged, INetPlayer
    {
        ...
        public event Action<INetPlayer, UserInterface.InputType, Keyboard.ScanCodes, Keyboard.ControlCodes, ulong> OnInput
        {
            add { InputSubscriptions.Add(value); }
            remove { InputSubscriptions.Remove(value); }
        }

        internal readonly SubscriptionDelegate<
            Action<INetPlayer, UserInterface.InputType, Keyboard.ScanCodes, Keyboard.ControlCodes, ulong>
            > InputSubscriptions = new SubscriptionDelegate<
                Action<INetPlayer, UserInterface.InputType, Keyboard.ScanCodes, Keyboard.ControlCodes, ulong>
            >();
