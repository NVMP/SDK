...
{
    internal class BasicSDKMarshaler<NetRefType> : ICustomMarshaler
        where NetRefType : NetReference
    {
        public static ICustomMarshaler Instance { get; } = new BasicSDKMarshaler<NetRefType>();

        public static ICustomMarshaler GetInstance(string pstrCookie)
            => new BasicSDKMarshaler<NetRefType>();
        ...
        {
            var addr = (ManagedObj as NetRefType).__UnmanagedAddress;
            if (addr == IntPtr.Zero)
        ...
        public object MarshalNativeToManaged(IntPtr pNativeData)
        {
            ...
            return gchandle.Target as NetRefType;
        }
    }
}
